...
ButtonUsbTelnetTest = tk.Button(rootF, text="USB/TELNET Test", command=showRadioStatus)
...
#ButtonUSBConnection.place(x=210, y=5)
#ButtonTELNETConnection.place(x=270, y=5)
